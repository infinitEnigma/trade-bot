...
import {
  ...
  ProfileUpdateData,
  ProfileUpdateResult,
} from "../../src/core/user/user-profile.service";
...
describe("UserProfileService", () => {
  ...
  describe("getUserProfile", () => {
    ...
    it("should return user profile from cache if available", async () => {
      ...
      expect(
        mockUserRepository.getAuthenticatedUserData
    ...
    it("should retrieve user profile from database when cache misses", async () => {
      ...
      mockUserRepository.getAuthenticatedUserData.mockResolvedValue(
        mockUserData
      );
      ...
      expect(mockUserRepository.getAuthenticatedUserData).toHaveBeenCalledWith(
        mockUserId
      );
