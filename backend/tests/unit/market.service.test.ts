...
} from "../../src/core/market/market.service";
...
describe("MarketService", () => {
  ...
  describe("getMarketPrices", () => {
    ...
    it("should handle errors when retrieving market prices", async () => {
      ...
      await expect(marketService.getMarketPrices()).rejects.toThrow(
  ...
  describe("getAvailableTradingPairs", () => {
    ...
    it("should handle errors when retrieving trading pairs", async () => {
      ...
      await expect(marketService.getAvailableTradingPairs()).rejects.toThrow(
  ...
  describe("getMarketDepth", () => {
    ...
    it("should retrieve market depth with custom limit", async () => {
      ...
      const result = await marketService.getMarketDepth(
        "ETH/USDT",
        customLimit
      );
    ...
    it("should handle errors when retrieving market depth", async () => {
      ...
      await expect(marketService.getMarketDepth("BTC/USDT")).rejects.toThrow(
        "Failed to get market depth"
      );
      expect(deps.logger.error).toHaveBeenCalled();
    });
  });
