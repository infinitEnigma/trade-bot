...
import {
  RedisCacheAdapter,
  redisCacheAdapter,
} from "../../src/infrastructure/adapters/cache/redis-cache.adapter";
...
describe("RedisCacheAdapter", () => {
  ...
  describe("get", () => {
    it("should get a value from cache successfully with JSON parsing", async () => {
      ...
      require("../../src/infrastructure/cache/redis.service").redisService.get =
        mockGet;
  ...
  describe("set", () => {
    it("should set a value in cache successfully without TTL", async () => {
      ...
      require("../../src/infrastructure/cache/redis.service").redisService.set =
        mockSet;
    ...
    it("should set a value in cache successfully with TTL", async () => {
      ...
      require("../../src/infrastructure/cache/redis.service").redisService.setex =
        mockSetex;
  ...
  describe("delete", () => {
    it("should delete a value from cache successfully", async () => {
      ...
      require("../../src/infrastructure/cache/redis.service").redisService.del =
        mockDel;
  ...
  describe("exists", () => {
    it("should check if a key exists in cache successfully (exists)", async () => {
      ...
      require("../../src/infrastructure/cache/redis.service").redisService.exists =
        mockExists;
  ...
  describe("atomicConditionalUpdate", () => {
    it("should perform atomic conditional update successfully", async () => {
      ...
      require("../../src/infrastructure/cache/redis.service").redisService.atomicConditionalUpdate =
        mockAtomicConditionalUpdate;

      const result = await adapter.atomicConditionalUpdate(
        mockKey,
        mockNewValue,
        mockExpectedValue
      );
    ...
    it("should handle exception when performing atomic conditional update", async () => {
      ...
      const mockAtomicConditionalUpdate = jest
        .fn()
        .mockRejectedValue(new Error("Unexpected error"));
