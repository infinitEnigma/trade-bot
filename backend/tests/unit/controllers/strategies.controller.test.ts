...
function createTestApp(): Express {
  ...
  const {
    strategyRoutes,
  } = require("../../../src/interfaces/http/trading/strategies");
  ...
  describe("Strategy Management Routes", () => {
    describe("GET /api/strategies", () => {
      it("should return list of strategies for authenticated user", async () => {
        ...
        const diContainer =
          require("../../../src/infrastructure/dependency-injection.container").diContainer;
        diContainer.strategyService.getStrategies.mockResolvedValue(
          mockStrategies
        );
        ...
        expect(diContainer.strategyService.getStrategies).toHaveBeenCalledWith(
          "user-123"
        );
      });
      ...
      it("should handle errors when fetching strategies", async () => {
        const diContainer =
          require("../../../src/infrastructure/dependency-injection.container").diContainer;
        diContainer.strategyService.getStrategies.mockRejectedValue(
          new Error("Database error")
        );

        const response = await request(app).get("/api/strategies").expect(500);
    ...
    describe("POST /api/strategies", () => {
      it("should create a new strategy", async () => {
        ...
        const diContainer =
          require("../../../src/infrastructure/dependency-injection.container").diContainer;
        diContainer.strategyService.createStrategy.mockResolvedValue(
          mockStrategy
        );
        ...
        expect(diContainer.strategyService.createStrategy).toHaveBeenCalledWith(
          "user-123",
          expect.objectContaining({
            name: "Grid Trading BTC",
            type: "GRID",
      ...
      it("should handle errors when creating strategy", async () => {
        const diContainer =
          require("../../../src/infrastructure/dependency-injection.container").diContainer;
        diContainer.strategyService.createStrategy.mockRejectedValue(
          new Error("Database error")
        );
    ...
    describe("GET /api/strategies/:id", () => {
      it("should return strategy by id for authenticated user", async () => {
        ...
        expect(diContainer.strategyService.getStrategy).toHaveBeenCalledWith(
          "strategy-1"
        );
      });
      ...
      it("should handle errors when fetching strategy", async () => {
        const diContainer =
          require("../../../src/infrastructure/dependency-injection.container").diContainer;
        diContainer.strategyService.getStrategy.mockRejectedValue(
          new Error("Database error")
        );
    ...
    describe("PUT /api/strategies/:id", () => {
      it("should update strategy", async () => {
        ...
        const diContainer =
          require("../../../src/infrastructure/dependency-injection.container").diContainer;
        diContainer.strategyService.getStrategy.mockResolvedValue(
          existingStrategy
        );
        diContainer.strategyService.updateStrategy.mockResolvedValue(
          updatedStrategy
        );
        ...
        expect(diContainer.strategyService.updateStrategy).toHaveBeenCalledWith(
          "strategy-1",
          expect.objectContaining({
            name: "Updated Grid Trading BTC",
            type: "GRID",
      ...
      it("should handle errors when updating strategy", async () => {
        ...
        diContainer.strategyService.updateStrategy.mockRejectedValue(
          new Error("Database error")
        );
    ...
    describe("DELETE /api/strategies/:id", () => {
      it("should delete strategy", async () => {
        ...
        expect(diContainer.strategyService.deleteStrategy).toHaveBeenCalledWith(
          "strategy-1"
        );
      });
      ...
      it("should handle errors when deleting strategy", async () => {
        ...
        diContainer.strategyService.deleteStrategy.mockRejectedValue(
          new Error("Database error")
        );
    ...
    describe("GET /api/strategies/:id/performance", () => {
      it("should return strategy performance", async () => {
        ...
        const diContainer =
          require("../../../src/infrastructure/dependency-injection.container").diContainer;
        diContainer.strategyService.getStrategy.mockResolvedValue(mockStrategy);
        diContainer.strategyService.getStrategyPerformance.mockResolvedValue(
          mockPerformance
        );
        ...
        expect(
          diContainer.strategyService.getStrategyPerformance
      ...
      it("should handle errors when fetching strategy performance", async () => {
        ...
        const diContainer =
          require("../../../src/infrastructure/dependency-injection.container").diContainer;
        diContainer.strategyService.getStrategy.mockResolvedValue(mockStrategy);
        diContainer.strategyService.getStrategyPerformance.mockRejectedValue(
          new Error("Database error")
        );
