...
describe("Dependency Injection Container", () => {
  ...
  describe("Infrastructure Adapters", () => {
    ...
    it("should provide token service", () => {
      ...
      expect(typeof diContainer.tokenService.generateAccessToken).toBe(
        "function"
      );
      expect(typeof diContainer.tokenService.generateRefreshToken).toBe(
        "function"
      );
    ...
    it("should provide encryption service", () => {
      ...
      expect(typeof diContainer.encryptionService.encryptApiKey).toBe(
        "function"
      );
      expect(typeof diContainer.encryptionService.decryptApiKey).toBe(
        "function"
      );
      expect(typeof diContainer.encryptionService.encryptSecretKey).toBe(
        "function"
      );
      expect(typeof diContainer.encryptionService.decryptSecretKey).toBe(
        "function"
      );
    });
  ...
  describe("Convenience Functions", () => {
    ...
    it("should export repository service convenience functions", async () => {
      ...
      expect(getBotInstanceRepository()).toEqual(
        diContainer.botInstanceRepository
      );
    });
    ...
    it("should export business service convenience functions", async () => {
      ...
      expect(getBotManagementService()).toEqual(
        diContainer.botManagementService
      );
      ...
      expect(getPositionValidatorService()).toEqual(
