...
import {
  SignatureVerificationServiceAdapter,
  signatureVerificationServiceAdapter,
} from "../../src/infrastructure/adapters/security/signature-verification.adapter";
...
describe("SignatureVerificationServiceAdapter", () => {
  describe("Constructor", () => {
    ...
    it("should export singleton instance", () => {
      expect(signatureVerificationServiceAdapter).toBeInstanceOf(
        SignatureVerificationServiceAdapter
      );
    });
  });
