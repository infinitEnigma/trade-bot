...
describe("CircuitBreaker", () => {
  ...
  describe("executeWithCircuitBreaker", () => {
    ...
    it("should attempt recovery after recovery timeout", async () => {
      ...
      await new Promise(resolve =>
        setTimeout(resolve, defaultConfig.recoveryTimeout + 50)
      );
    ...
    it("should handle operation timeouts", async () => {
      const mockOperation = jest
        ...
        .mockImplementation(
          () =>
            new Promise(resolve =>
              setTimeout(resolve, defaultConfig.timeout + 50)
            )
        );
  ...
  describe("configuration", () => {
    ...
    it("should update partial configuration", () => {
      ...
      expect(analysis.config.recoveryTimeout).toEqual(
        defaultConfig.recoveryTimeout
      );
    });
  });
