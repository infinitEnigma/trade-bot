...
} from "../../src/shared/validation/schema-validation-middleware";
...
const __parseSchema = jest.requireMock(
  "../../src/shared/validation/database-schema-parser"
).__parseSchema;
const __generateAllSchemas = jest.requireMock(
  "../../src/shared/validation/schema-generator"
).__generateAllSchemas;
...
describe("SchemaValidationMiddleware", () => {
      ...
      return {
        users: Joi.object({
          ...
          user_level: Joi.string()
            .valid("BASIC", "VERIFIED", "PREMIUM", "ADMIN")
            .required(),
  ...
  describe("Database Validators", () => {
    it("should have predefined validators for common tables", () => {
      ...
      const {
        databaseValidators,
      } = require("../../src/shared/validation/schema-validation-middleware");
