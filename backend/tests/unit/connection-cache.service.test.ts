...
} from "../../src/infrastructure/cache/connection-cache.service";
...
describe("ConnectionCacheService", () => {
  ...
  describe("getCachedResult", () => {
    ...
    it("should evict and return null for expired entry", async () => {
      ...
      expect(logger.debug).toHaveBeenCalledWith(
        "Connection cache entry expired and removed",
        expect.any(Object)
      );
    });
  ...
  describe("setCachedResult", () => {
    ...
    it("should evict oldest entry when cache limit reached", async () => {
      ...
      jest
        .spyOn(service as any, "getUserCacheEntries")
        .mockImplementation(mockGetUserCacheEntries);
  ...
  describe("private methods", () => {
    ...
    it("should log error when evicting oldest entries fails", async () => {
      const mockGetUserCacheEntries = jest
        .fn()
        .mockRejectedValue(new Error("Redis connection error"));
      jest
        .spyOn(service as any, "getUserCacheEntries")
