...
import {
  ...
  botInstanceRepositoryAdapter,
} from "../../src/infrastructure/adapters/repositories/bot-instance-repository.adapter";
...
describe("BotInstanceRepositoryAdapter", () => {
  ...
  describe("Initialization", () => {
    ...
    it("should export a singleton instance", () => {
      expect(botInstanceRepositoryAdapter).toBeInstanceOf(
        BotInstanceRepositoryAdapter
      );
    });
  });
  ...
  describe("getBotInstances", () => {
    ...
    it("should throw error when query fails", async () => {
      ...
      await expect(adapter.getBotInstances(userId)).rejects.toThrow(
        "Failed to get bot instances"
      );
    });
  });
  ...
  describe("getBotInstance", () => {
    ...
    it("should throw error when query fails", async () => {
      ...
      await expect(adapter.getBotInstance(botId)).rejects.toThrow(
        "Failed to get bot instance"
      );
    });
  });
  ...
  describe("updateBotStatus", () => {
    ...
    it("should throw error when status update fails", async () => {
      ...
      await expect(adapter.updateBotStatus(botId, newStatus)).rejects.toThrow(
  ...
  describe("updateBotPerformance", () => {
    ...
    it("should throw error when performance update fails", async () => {
      ...
      await expect(
        adapter.updateBotPerformance(botId, metrics)
      ).rejects.toThrow("Failed to update bot performance");
    });
  });
  ...
  describe("deleteBotInstance", () => {
    ...
    it("should throw error when deletion fails", async () => {
      ...
      await expect(adapter.deleteBotInstance(botId)).rejects.toThrow(
        "Failed to delete bot instance"
      );
    });
  });
  ...
  describe("getActiveBotInstances", () => {
    ...
    it("should return active bot instances (RUNNING and STARTING)", async () => {
      ...
      expect(
        activeBots.every(bot => ["RUNNING", "STARTING"].includes(bot.status))
      ).toBe(true);
    });
    ...
    it("should throw error when query fails", async () => {
      ...
      await expect(adapter.getActiveBotInstances()).rejects.toThrow(
        "Failed to get active bot instances"
      );
    });
  });
});
