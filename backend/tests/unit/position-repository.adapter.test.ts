...
import {
  ...
  positionRepositoryAdapter,
} from "../../src/infrastructure/adapters/repositories/position-repository.adapter";
...
describe("PositionRepositoryAdapter", () => {
  ...
  describe("Initialization", () => {
    ...
    it("should export a singleton instance", () => {
      expect(positionRepositoryAdapter).toBeInstanceOf(
        PositionRepositoryAdapter
      );
    });
  });
  ...
  describe("getPositions", () => {
    ...
    it("should throw error when query fails", async () => {
      ...
      await expect(adapter.getPositions(userId)).rejects.toThrow(
  ...
  describe("updatePosition", () => {
    ...
    it("should throw error when update fails", async () => {
      ...
      await expect(adapter.updatePosition(userId, position)).rejects.toThrow(
  ...
  describe("closePosition", () => {
    ...
    it("should throw error when close fails", async () => {
      ...
      await expect(adapter.closePosition(userId, symbol)).rejects.toThrow(
