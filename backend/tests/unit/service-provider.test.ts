...
import {
  ...
  getAuthServiceSafe,
  getBalanceService,
  getBalanceServiceSafe,
  getPositionService,
  getPositionServiceSafe,
  getRoleManagementService,
  getRoleManagementServiceSafe,
  getRoleQualificationService,
  getRoleQualificationServiceSafe,
  getWalletQualificationService,
  ...
  getStrategyService,
  getStrategyServiceSafe,
  getMarketService,
  getMarketServiceSafe,
  getPositionValidatorService,
  getPositionValidatorServiceSafe,
  getPositionSyncService,
  getPositionSyncServiceSafe,
  getHealthService,
  getHealthServiceSafe,
  getEngineManager,
  getEngineManagerSafe,
  isServiceAvailable,
...
describe("Service Provider Singleton", () => {
  ...
  describe("Error Handling", () => {
    ...
    test("should throw error when Auth Service is unavailable", () => {
      ...
      (serviceProvider as any).factory = mockFactory;
      expect(() => serviceProvider.getAuthService()).toThrow(
    ...
    test("should throw error when Balance Service is unavailable", () => {
      ...
      (serviceProvider as any).factory = mockFactory;
      expect(() => serviceProvider.getBalanceService()).toThrow(
        "Balance Service is unavailable"
      );
    });
    ...
    test("should throw error when Position Service is unavailable", () => {
      ...
      (serviceProvider as any).factory = mockFactory;
      expect(() => serviceProvider.getPositionService()).toThrow(
    ...
    test("should throw error when Role Management Service is unavailable", () => {
      ...
      (serviceProvider as any).factory = mockFactory;
      expect(() => serviceProvider.getRoleManagementService()).toThrow(
    ...
    test("should throw error when Role Qualification Service is unavailable", () => {
      ...
      (serviceProvider as any).factory = mockFactory;
      expect(() => serviceProvider.getRoleQualificationService()).toThrow(
        "Role Qualification Service is unavailable"
      );
    });
    ...
    test("should throw error when Wallet Qualification Service is unavailable", () => {
      ...
      (serviceProvider as any).factory = mockFactory;
      expect(() => serviceProvider.getWalletQualificationService()).toThrow(
        "Wallet Qualification Service is unavailable"
      );
    });
    ...
    test("should throw error when User Profile Service is unavailable", () => {
      ...
      (serviceProvider as any).factory = mockFactory;
      expect(() => serviceProvider.getUserProfileService()).toThrow(
    ...
    test("should throw error when Bot Management Service is unavailable", () => {
      ...
      (serviceProvider as any).factory = mockFactory;
      expect(() => serviceProvider.getBotManagementService()).toThrow(
        "Bot Management Service is unavailable"
      );
    });
    ...
    test("should throw error when Strategy Service is unavailable", () => {
      ...
      (serviceProvider as any).factory = mockFactory;
      expect(() => serviceProvider.getStrategyService()).toThrow(
        "Strategy Service is unavailable"
      );
    });
    ...
    test("should throw error when Market Service is unavailable", () => {
      ...
      (serviceProvider as any).factory = mockFactory;
      expect(() => serviceProvider.getMarketService()).toThrow(
    ...
    test("should throw error when Position Validator Service is unavailable", () => {
      ...
      (serviceProvider as any).factory = mockFactory;
      expect(() => serviceProvider.getPositionValidatorService()).toThrow(
        "Position Validator Service is unavailable"
      );
    });
    ...
    test("should throw error when Position Sync Service is unavailable", () => {
      ...
      (serviceProvider as any).factory = mockFactory;
      expect(() => serviceProvider.getPositionSyncService()).toThrow(
        "Position Sync Service is unavailable"
      );
    });
    ...
    test("should throw error when Health Service is unavailable", () => {
      ...
      (serviceProvider as any).factory = mockFactory;
      expect(() => serviceProvider.getHealthService()).toThrow(
    ...
    test("should throw error when Engine Manager is unavailable", () => {
      ...
      (serviceProvider as any).factory = mockFactory;
      expect(() => serviceProvider.getEngineManager()).toThrow(
        "Engine Manager is unavailable"
      );
    });
