...
import {
  ...
  kodiakCredentialsRepositoryAdapter,
} from "../../src/infrastructure/adapters/repositories/kodiak-credentials-repository.adapter";
...
describe("KodiakCredentialsRepositoryAdapter", () => {
  ...
  describe("Initialization", () => {
    ...
    it("should export a singleton instance", () => {
      expect(kodiakCredentialsRepositoryAdapter).toBeInstanceOf(
        KodiakCredentialsRepositoryAdapter
      );
    });
  });
  ...
  describe("getCredentials", () => {
    ...
    it("should throw error when query fails", async () => {
      ...
      await expect(adapter.getCredentials(userId)).rejects.toThrow(
        "Failed to get Kodiak credentials"
      );
    });
  });
  ...
  describe("saveCredentials", () => {
    ...
    it("should throw error when creation fails", async () => {
      ...
      await expect(adapter.saveCredentials(mockCredentials)).rejects.toThrow(
    ...
    it("should throw error when query fails", async () => {
      ...
      await expect(adapter.saveCredentials(mockCredentials)).rejects.toThrow(
        "Failed to save Kodiak credentials"
      );
    });
  });
  ...
  describe("updateVerificationStatus", () => {
    ...
    it("should throw error when credentials not found", async () => {
      ...
      await expect(
        adapter.updateVerificationStatus(userId, verified)
  ...
  describe("updateWalletAddress", () => {
    ...
    it("should throw error when credentials not found", async () => {
      ...
      await expect(
        adapter.updateWalletAddress(userId, walletAddress)
      ).rejects.toThrow("Credentials not found");
    });
    ...
    it("should throw error when query fails", async () => {
      ...
      await expect(
        adapter.updateWalletAddress(userId, walletAddress)
      ).rejects.toThrow("Failed to update wallet address");
    });
  });
  ...
  describe("deleteCredentials", () => {
    ...
    it("should throw error when credentials not found", async () => {
      ...
      await expect(adapter.deleteCredentials(userId)).rejects.toThrow(
