...
export const getThemeFromCSS = (): StyledTheme => {
  ...
  return {
    colors: {
      ...
      primaryHover:
        computedStyle.getPropertyValue("--primary-hover") ||
        darkTheme.colors.primaryHover,
      secondary:
        computedStyle.getPropertyValue("--secondary") ||
        darkTheme.colors.secondary,
      secondaryHover:
        computedStyle.getPropertyValue("--secondary-hover") ||
        darkTheme.colors.secondaryHover,
      accent:
        computedStyle.getPropertyValue("--accent") || darkTheme.colors.accent,
      danger:
        computedStyle.getPropertyValue("--danger") || darkTheme.colors.danger,
      warning:
      ...
      background: {
        ...
        surface:
          computedStyle.getPropertyValue("--bg-surface") ||
          darkTheme.colors.background.surface,
        surfaceLight:
          computedStyle.getPropertyValue("--bg-surface-light") ||
          darkTheme.colors.background.surfaceLight,
        glass:
          computedStyle.getPropertyValue("--bg-glass") ||
          darkTheme.colors.background.glass,
        glassHover:
          computedStyle.getPropertyValue("--bg-glass-hover") ||
          darkTheme.colors.background.glassHover,
        input:
          computedStyle.getPropertyValue("--bg-input") ||
          darkTheme.colors.background.input,
        inputFocus:
          computedStyle.getPropertyValue("--bg-input-focus") ||
          darkTheme.colors.background.inputFocus,
        tableHeader:
          computedStyle.getPropertyValue("--bg-table-header") ||
          darkTheme.colors.background.tableHeader,
        tooltip:
